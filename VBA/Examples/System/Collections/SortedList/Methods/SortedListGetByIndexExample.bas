Attribute VB_Name = "SortedListGetByIndexExample"
...
'
'@Reference https://learn.microsoft.com/en-us/dotnet/api/system.collections.sortedlist.getbyindex?view=netframework-4.8.1#examples
...
' a SortedList object.
''
Public Sub SortedListGetByIndex()
