Attribute VB_Name = "SortedListRemoveAtExample"
...
'
'@Reference https://learn.microsoft.com/en-us/dotnet/api/system.collections.sortedlist.removeat?view=netframework-4.8.1#examples
