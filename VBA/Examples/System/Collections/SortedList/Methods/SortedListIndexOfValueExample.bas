...
Public Sub SortedListIndexOfValue()
    ...
    Dim myKey As Long
    myKey = 2
    Debug.Print VBString.Format("The key ""{0}"" is at index {1}.", myKey, mySL.IndexOfKey(myKey))

    ' Searches for a specific value.
    Dim myValue As String
    myValue = "three"
    Debug.Print VBString.Format("The value ""{0}"" is at index {1}.", myValue, mySL.IndexOfValue(myValue))
End Sub
