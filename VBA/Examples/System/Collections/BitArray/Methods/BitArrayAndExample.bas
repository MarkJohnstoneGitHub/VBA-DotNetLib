...
'@Reference https://learn.microsoft.com/en-us/dotnet/api/system.collections.bitarray.and?view=netframework-4.8.1#examples

Option Explicit

''
' The following code example shows how to perform the bitwise AND operation
' between two BitArray objects.
''
Public Sub BitArrayAndExample()
    ...
    Debug.Print "Result"
    Debug.Print "AND:";
    Call PrintValues(myBA1.And(myBA2), 8)
    Debug.Print

    Debug.Print ("After AND")
    Debug.Print ("myBA1:");
    Call PrintValues(myBA1, 8)
    Debug.Print ("myBA2:");
    Call PrintValues(myBA2, 8)
