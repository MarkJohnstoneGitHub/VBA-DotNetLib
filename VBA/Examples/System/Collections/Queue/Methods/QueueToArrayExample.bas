Attribute VB_Name = "QueueToArrayExample"
'@Folder("Examples.System.Collections.Queue.Methods")

'@Author Mark Johnstone
'@Project https://github.com/MarkJohnstoneGitHub/VBA-DotNetLib
'@Version v1.0 October 23, 2023
'@LastModified October 23, 2023

'@Reference https://learn.microsoft.com/en-us/dotnet/api/system.collections.queue.toarray?view=netframework-4.8.1#examples
...
''
Public Sub QueueToArray()
    ' Creates and initializes the source Queue.
    Dim mySourceQ As DotNetLib.Queue
    Set mySourceQ = Queue.Create()
    Call mySourceQ.Enqueue("three")
    Call mySourceQ.Enqueue("napping")
    Call mySourceQ.Enqueue("cats")
    Call mySourceQ.Enqueue("in")
    Call mySourceQ.Enqueue("the")
    Call mySourceQ.Enqueue("barn")
