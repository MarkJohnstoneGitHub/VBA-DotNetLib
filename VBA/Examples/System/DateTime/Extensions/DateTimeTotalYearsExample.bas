...
Public Sub DateTimeTotalYears()
    ...
    Debug.Print VBString.Format("Number of years between {0} and {1} = {2} years", startDate, endDate, DateTime.TotalYears(startDate, endDate))
    Debug.Print VBString.Format("Number of years between {0} and {1} = {2} years", endDate, startDate, DateTime.TotalYears(endDate, startDate))
    Debug.Print
