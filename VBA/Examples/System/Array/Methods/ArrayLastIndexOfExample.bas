...
Public Sub ArrayLastIndexOf()
    ...
    Debug.Print Strings.Format("The last occurrence of ""{0}"" between index 5 and index 10 is at index {1}.", myString, myIndex)
End Sub
...
Private Sub PrintIndexAndValues(ByVal anArray As DotNetLib.Array)
    ...
    For i = anArray.GetLowerBound(0) To anArray.GetUpperBound(0)
        Debug.Print Strings.Format(formatString, i, anArray.GetValue(i))
    Next i
End Sub
