Attribute VB_Name = "StringBuilderLengthExample"
...
'@Reference https://learn.microsoft.com/en-us/dotnet/api/system.text.stringbuilder.length?view=netframework-4.8.1#examples
...
''
Public Sub StringBuilderLength()
