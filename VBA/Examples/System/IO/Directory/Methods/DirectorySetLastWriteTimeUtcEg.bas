Attribute VB_Name = "DirectorySetLastWriteTimeUtcEg"
...
'@Reference https://learn.microsoft.com/en-us/dotnet/api/system.io.directory.setlastwritetimeutc?view=netframework-4.8.1#examples
...
''
Public Sub DirectorySetLastWriteTimeUtc()
    ' Set the directory.
    Dim n As String
    n = "C:\test\newdir"
