Attribute VB_Name = "DirectorySetLastAccessTimeUtcEg"
...
'@Reference https://learn.microsoft.com/en-us/dotnet/api/system.io.directory.setlastaccesstimeutc?view=netframework-4.8.1#examples
...
''
Public Sub DirectorySetLastAccessTimeUtc()
    ' Set the directory.
    Dim n As String
    n = "C:\test\newdir"
