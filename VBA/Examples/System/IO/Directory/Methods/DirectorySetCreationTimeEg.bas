Attribute VB_Name = "DirectorySetCreationTimeEg"
...
'@Reference https://learn.microsoft.com/en-us/dotnet/api/system.io.directory.setcreationtime?view=netframework-4.8.1#examples
...
''
Public Sub DirectorySetCreationTime()
    ' Set the directory.
    Dim n As String
    n = "C:\test\newdir"
