Attribute VB_Name = "UriGetLeftPartExample"
...
'@Reference https://learn.microsoft.com/en-us/dotnet/api/system.uri.getleftpart?view=netframework-4.8.1#examples
...
''
Public Sub UriGetLeftPartExample()
    ' Create Uri
