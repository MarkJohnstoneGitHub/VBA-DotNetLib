Attribute VB_Name = "UriIsDefaultPortExample"
...
'@Reference https://learn.microsoft.com/en-us/dotnet/api/system.uri.isdefaultport?view=netframework-4.8.1#examples

Option Explicit

''
' The following example creates a Uri instance and checks whether it uses the
' default port.
''
Public Sub UriIsDefaultPortExample()
