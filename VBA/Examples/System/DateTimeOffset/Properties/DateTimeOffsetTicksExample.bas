...
''
' The following example initializes a DateTimeOffset object by approximating
' the number of ticks in the date July 1, 2008 1:23:07. It then displays the
' date and the number of ticks represented by that date.
''
Public Sub DateTimeOffsetTicks()
    ...
    Debug.Print VBString.Format("There are {0:n0} ticks in {1}.", _
                                dto.Ticks, _
                                dto.ToString())
End Sub
