...
''
' The following example displays a DateTimeOffset object to the console using
' each of the standard date and time format specifiers.
...
Public Sub DateTimeOffsetToString2()
    ...
    Debug.Print VBString.Format("{0}: {1}", specifier, outputDate.ToString2(specifier))
    ...
    If Catch(FormatException) Then
        Debug.Print VBString.Format("{0}: Not supported.", specifier)
    End If
