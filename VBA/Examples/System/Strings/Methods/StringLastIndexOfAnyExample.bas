Attribute VB_Name = "StringLastIndexOfAnyExample"
...
'@Reference https://learn.microsoft.com/en-us/dotnet/api/system.string.lastindexofany?view=netframework-4.8.1#system-string-lastindexofany(system-char())
...
' in the string "is" within another string.
''
Public Sub StringLastIndexOfAnyExample()
    Dim br1 As String
    br1 = "0----+----1----+----2----+----3----+----4----+----5----+----6----+-"
    Dim br2 As String
    ...
    Debug.Print VBAString.Format("The last character occurrence  from position {0} to 0.", pvtStart)
