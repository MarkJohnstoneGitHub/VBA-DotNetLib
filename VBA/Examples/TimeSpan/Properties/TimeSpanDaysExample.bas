...
'@Description("The following example creates several TimeSpan objects and displays the Days property of each.")
...
Private Sub ShowTimeSpanProperties(ByVal interval As TimeSpan)
   ...
   Debug.Print "Milliseconds", interval.Milliseconds, "TotalMilliseconds", interval.TotalMilliseconds
   Debug.Print , , "Ticks", interval.Ticks
