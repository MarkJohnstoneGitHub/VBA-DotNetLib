...
'@DotNetReference https://learn.microsoft.com/en-us/dotnet/api/system.datetime.addseconds?view=netframework-4.8.1#examples
...
Public Sub DateTimeAddSeconds()
   ...
   Set date3 = date1.AddSeconds(60 * 60 * 24)
