...
Oct 3, 2023 Added [ListString](https://learn.microsoft.com/en-us/dotnet/api/system.collections.generic.list-1?view=netframework-4.8.1) for List<String>.
...
- Work in progress testing still to be done. Creating, adding, sorting, reverse appears functional.
