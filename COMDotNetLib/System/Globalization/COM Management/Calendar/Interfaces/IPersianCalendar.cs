// https://learn.microsoft.com/en-us/dotnet/api/system.globalization.persiancalendar.persianera?view=netframework-4.8.1
...
{
    [ComVisible(true)]
    [Guid("B18A0973-5AE3-42FE-AF06-650DA823FE1D")]
    ...
    public interface IPersianCalendar : ICalendar
    {
        ...
        new int[] Eras
        {
            [Description("Gets the list of eras in a PersianCalendar object.")]
            get;
        }
        ...
        {
            [Description("Gets the latest date and time supported by the PersianCalendar class.")]
            get;
        }

        new DateTime MinSupportedDateTime
        {
            [Description("Gets the earliest date and time supported by the PersianCalendar class.")]
            get;
        }
