...
namespace DotNetLib.System.Globalization
{
    ...
    public interface IUmAlQuraCalendar : ICalendar
    {
        ...
        //new int DaysInYearBeforeMinSupportedYear
        //{
        ...
        new int[] Eras
        {
            [Description("Gets a list of the eras that are supported by the current UmAlQuraCalendar.")]
            get;
        }
        ...
        {
            [Description("Gets the latest date and time supported by this calendar.")]
            get;
        }

        new DateTime MinSupportedDateTime
        {
            [Description("Gets the earliest date and time supported by this calendar.")]
            get;
        }
