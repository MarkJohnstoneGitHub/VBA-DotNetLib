...
namespace DotNetLib.System.Globalization
{
    ...
    public interface IGregorianCalendar : Calendar
    {
        ...
        new int[] Eras
        {
            [Description("Gets the list of eras in the GregorianCalendar.")]
            get;
        }
        ...
        {
            [Description("Gets the latest date and time supported by the GregorianCalendar type.")]
            get;
        }

        new DateTime MinSupportedDateTime
        {
            [Description("Gets the earliest date and time supported by the GregorianCalendar type.")]
            get;
        }
