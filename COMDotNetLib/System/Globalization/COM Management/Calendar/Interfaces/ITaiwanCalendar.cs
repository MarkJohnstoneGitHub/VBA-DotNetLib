...
{
    [ComVisible(true)]
    [Guid("AF765C51-4FF9-4AE8-A4B1-B8B7DFB5ACBE")]
    ...
    public interface ITaiwanCalendar : ICalendar
    {
        ...
        new int[] Eras
        {
            [Description("Gets the list of eras in the TaiwanCalendar.")]
            get;
        }
        ...
        {
            [Description("Gets the latest date and time supported by the TaiwanCalendar class.")]
            get;
        }

        new DateTime MinSupportedDateTime
        {
            [Description("Gets the earliest date and time supported by the TaiwanCalendar class.")]
            get;
        }
