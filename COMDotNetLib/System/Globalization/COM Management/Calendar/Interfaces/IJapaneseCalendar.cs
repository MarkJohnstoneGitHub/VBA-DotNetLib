...
namespace DotNetLib.System.Globalization
{
    ...
    public interface IJapaneseCalendar : ICalendar
    {
        ...
        new int[] Eras
        {
            [Description("Gets the list of eras in the JapaneseCalendar.")]
            get;
        }
        ...
        {
            [Description("Gets the latest date and time supported by the current JapaneseCalendar object.")]
            get;
        }

        new DateTime MinSupportedDateTime
        {
            [Description("Gets the earliest date and time supported by the current JapaneseCalendar object.")]
            get;
        }
