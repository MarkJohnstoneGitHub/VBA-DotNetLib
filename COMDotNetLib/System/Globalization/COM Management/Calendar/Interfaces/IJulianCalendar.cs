...
namespace DotNetLib.System.Globalization
{
    ...
    public interface IJulianCalendar  : Calendar
    {
        ...
        new int[] Eras
        {
            [Description("Gets the list of eras in the JulianCalendar.")]
            get;
        }
        ...
        {
            [Description("Gets the latest date and time supported by the JulianCalendar class.")]
            get;
        }

        new DateTime MinSupportedDateTime
        {
            [Description("Gets the earliest date and time supported by the JulianCalendar class.")]
            get;
        }
