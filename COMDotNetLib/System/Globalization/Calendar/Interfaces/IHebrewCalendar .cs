...
namespace DotNetLib.System.Globalization
{
    ...
    public interface IHebrewCalendar : Calendar
    {
        ...
        new int[] Eras
        {
            [Description("Gets the list of eras in the HebrewCalendar.")]
            get;
        }
        ...
        {
            [Description("Gets the latest date and time supported by the HebrewCalendar type.")]
            get;
        }

        new DateTime MinSupportedDateTime
        {
            [Description("Gets the earliest date and time supported by the HebrewCalendar type.")]
            get;
        }
