...
namespace DotNetLib.System
{
    ...
    public interface IDateTimeSingleton
    {
        ...
        DateTime CreateFromDate2(int pYear, int pMonth, int pDay, Calendar pCalendar);
        ...
        DateTime CreateFromDateTime2(int pYear, int pMonth, int pDay, int pHour, int pMinute, int pSecond, Calendar pCalendar);
        ...
        DateTime CreateFromDateTime3(int pYear, int pMonth, int pDay, int pHour, int pMinute, int pSecond, int pMillisecond, Calendar pCalendar);
        ...
        DateTime CreateFromDateTimeKind3(int pYear, int pMonth, int pDay, int pHour, int pMinute, int pSecond, int pMillisecond, Calendar pCalendar, DateTimeKind pKind);
