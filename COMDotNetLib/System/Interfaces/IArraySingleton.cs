...
namespace DotNetLib.System
{
    ...
    public interface IArraySingleton
    {
        ...
        int BinarySearch_2(Array array, object value, GCollections.IComparer comparer = null);
        ...
        int BinarySearch_3(Array array, int index, int length, object value, GCollections.IComparer comparer = null);

        //[Description("Searches an entire one-dimensional sorted array for a specific element, using the IComparable interface implemented by each element of the array and by the specified object.")]
        //int BinarySearch_2(Array array, object value);
        ...
        //int BinarySearch_2(Array array, int index, int length, object value);
        ...
        void Copy_2(Array sourceArray, Array destinationArray, long length);
        ...
        void Copy_3(Array sourceArray, int sourceIndex, Array destinationArray, int destinationIndex, int length);
        ...
        Array CreateInstance_2(Type elementType, int length1, int length2);

        [Description("Creates a three-dimensional Array of the specified Type and dimension lengths, with zero-based indexing.")]
        Array CreateInstance_3(Type elementType, int length1, int length2, int length3);
        ...
        Array CreateInstance_4(Type elementType, [In] ref int[] lengths);
        ...
        Array CreateInstance_5(Type elementType, [In] ref long[] lengths);

        [Description("Creates a multidimensional Array of the specified Type and dimension lengths, with the specified lower bounds.")]
        Array CreateInstance_6(Type elementType, [In] ref int[] lengths, [In] ref int[] lowerBounds);
        ...
        int IndexOf_2(Array array, object value, int startIndex);
        ...
        int IndexOf_3(Array array, object value, int startIndex, int count);
        ...
        int LastIndexOf_2(Array array, object value, int startIndex);
        ...
        int LastIndexOf_3(Array array, object value, int startIndex, int count);
        ...
        void Reverse_2(Array array, int index, int length);
        ...
        //[Description("")]
        //void Sort_2(Array array, int index, int length);

        [Description("Sorts the elements in a range of elements in a one-dimensional Array using the specified IComparer.")]
        void Sort_2(Array array, int index, int length, GCollections.IComparer comparer = null);
        ...
        //void Sort_2(Array keys, Array items);
        ...
        void Sort_3(Array keys, Array items, GCollections.IComparer comparer = null);
        ...
        //void Sort_2(Array keys, Array items, int index, int length);
        ...
        void Sort_4(Array keys, Array items, int index, int length, GCollections.IComparer comparer = null);
