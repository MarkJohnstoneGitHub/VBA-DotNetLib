...
namespace DotNetLib.System.Text.RegularExpressions
{
    ...
    public interface IRegex
    {
        ...
        [Description("In a specified input string, replaces a specified maximum number of strings that match a regular expression pattern with a specified replacement string.")]
        string Replace2(string input, string replacement, int count);
        ...
        string Replace3(string input, string replacement, int count, int startat);
        ...
        string Replace4(string input, MatchEvaluator evaluator);
        ...
        string Replace5(string input, MatchEvaluator evaluator, int count);
        ...
        string Replace6(string input, MatchEvaluator evaluator, int count, int startat);
