...
{
    [ComVisible(true)]
    [Guid("7DBD2FCD-9E4D-4053-854E-148F2823B773")]
    [Description("Represents a UTF-7 encoding of Unicode characters.")]
    [InterfaceType(ComInterfaceType.InterfaceIsDual)]
    public interface IUTF7Encoding
    {
        string BodyName
        {
        ...
        [Description("Gets a value indicating whether the specified object is equal to the current UTF7Encoding object.")]
        ...
        [Description("Obtains a decoder that converts a UTF-7 encoded sequence of bytes into a sequence of Unicode characters.")]
        GText.Decoder GetDecoder();

        [Description("Obtains an encoder that converts a sequence of Unicode characters into a UTF-7 encoded sequence of bytes.")]
        GText.Encoder GetEncoder();

        [Description("Returns the hash code for the current UTF7Encoding object.")]
        int GetHashCode();
