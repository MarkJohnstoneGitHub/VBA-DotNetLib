...
{
    [ComVisible(true)]
    [Guid("8E7EA3D3-654C-4455-B130-A2CA16799FD1")]
    [Description("Represents a UTF-32 encoding of Unicode characters.")]
    [InterfaceType(ComInterfaceType.InterfaceIsDual)]
    public interface IUTF32Encoding
    {
        string BodyName
        {
        ...
        [Description("Determines whether the specified Object is equal to the current UTF32Encoding object.")]
        ...
        [Description("Obtains a decoder that converts a UTF-32 encoded sequence of bytes into a sequence of Unicode characters.")]
        GText.Decoder GetDecoder();

        [Description("Obtains an encoder that converts a sequence of Unicode characters into a UTF-32 encoded sequence of bytes.")]
        ...
        [Description("Returns a Unicode byte order mark encoded in UTF-32 format, if the UTF32Encoding object is configured to supply one.")]
        byte[] GetPreamble();
