...
namespace DotNetLib.System
{
    ...
    public interface IDateTimeOffset
    {
        ...
        IDateTimeOffset Add(ITimeSpan timeSpan);
        ...
        IDateTimeOffset AddDays(double days);
        ...
        IDateTimeOffset AddHours(double hours);
        ...
        IDateTimeOffset AddMilliseconds(double milliseconds);
        ...
        int CompareTo(IDateTimeOffset other);
        ...
        bool Equals(IDateTimeOffset other);
        ...
        bool EqualsExact(IDateTimeOffset other);
        ...
        IDateTimeOffset ToOffset(ITimeSpan offset);
